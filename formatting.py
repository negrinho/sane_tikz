...
def convert_fractional_to_integral_colormap(cmap):
    return [tuple([int(round(255 * x)) for x in xs]) for xs in cmap]
...
# not about the licensing of this. keeping it for now.
def google_slides_named_colors():
    return {
        # row 1
        "black": (0, 0, 0),
...
def seaborn_colors():
    # https://seaborn.pydata.org/tutorial/color_palettes.html
    return [(76, 113, 176), (221, 131, 82), (85, 168, 103), (129, 113, 179),
            (147, 120, 96), (218, 139, 195), (140, 140, 140), (205, 185, 115),
            (100, 181, 205)]
